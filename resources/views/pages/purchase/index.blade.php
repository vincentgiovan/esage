...
<table class="w-100">
    <tr>
        ...
        <th class="border border-1 border-dark ">purchase Id</th>
    ...
    @foreach ($purchases as $p)
        <tr>
            ...
            <td class="border border-1 border-dark " >{{ $p->purchase_name }}</td>
            <td class="border border-1 border-dark " >{{ $p->supplier_id }}</td>
            <td class="border border-1 border-dark " >{{ $p->purchase_deadline }}</td>
            <td class="border border-1 border-dark " >{{ $p->purchase_id }}</td>
