...
{{-- @csrf kepake untuk token ,wajib --}}
            @csrf
            <div class="mt-3">
                <input type="text" class="form-control" name="partner_name" placeholder="Nama Partner" value = "{{ old("partner_name" ) }}">
                @error("partner_name")
            ...
            <div class="mt-3">
                <input type="text" class="form-control" name="contact" placeholder="Kontak"  value = "{{ old("contact") }}">
                @error("contact")
                <p style = "color: red; font-size: 10px;">{{$message }}</p>
                @enderror
            </div>
            <div class="mt-3">
                <input type="text" class="form-control" name="phone" placeholder="No Telp" value = "{{ old("phone") }}">
                @error("phone")
                <p style = "color: red; font-size: 10px;">{{$message }}</p>
                @enderror
            </div>
            ...
            <div class="mt-3">
                <input type="text" class="form-control" name="tempo" placeholder="Tempo"  value = "{{ old("tempo") }}">
                @error("tempo")
                <p style = "color: red; font-size: 10px;">{{$message  }}</p>
                @enderror
            </div>
