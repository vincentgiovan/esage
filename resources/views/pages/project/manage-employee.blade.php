...
@section("content")
    <x-container>
        <br>
        <h3>Daftar Karyawan di Proyek {{ $project->project_name }}</h3>
        ...
        <h6 class="mt-4">Tambah Karyawan ke Proyek</h6>
        ...
        <h6 class="mt-4">Daftar Karyawan</h6>
                        ...
                        <td class="border border-1 border-secondary " style="width: 150px;">
                            <div class="d-flex gap-2 w-100 justify-content-center">
                                <form action="{{ route('project-manageemployee-unassign', $project->id) }}" method="post" class="d-flex gap-2 w-100 justify-content-center">
                                    ...
                                    <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus karyawan ini dari proyek ini?')"><i class="bi bi-trash3"></i></button>
                                </form>
                            </div>
                        </td>
