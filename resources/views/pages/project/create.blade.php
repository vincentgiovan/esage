...
{{-- @csrf kepake untuk token ,wajib --}}
            @csrf
            <div class="mt-3">
                <input type="text" class="form-control" name="project_name" placeholder="Nama Project" value = "{{ old("project_name" ) }}">
                @error("project_name")
            ...
            <div class="mt-3">
                <input type="text" class="form-control" name="PIC" placeholder="PIC Name"  value = "{{ old("PIC") }}">
                @error("PIC")
                <p style = "color: red; font-size: 10px;">{{$message }}</p>
                @enderror
            </div>
