<nav class="navbar navbar-expand-lg w-100" style="background: rgb(24, 147, 255); box-shadow: none;">
    <div class="container-fluid d-flex justify-content-between">
        ...
        <div class="position-relative d-flex flex-column align-items-end">
            ...
            <div class="bg-white rounded-3 overflow-hidden position-absolute z-2 border border-1" id="prof-menu" style="display: none; top: 40px;">
                ...
                <a class="dropdown-item border border-1 py-2 px-4" href="{{ route('profile-edit') }}"><i class="bi bi-person-vcard"></i> Profile</a></li>
            </div>
        </div>
