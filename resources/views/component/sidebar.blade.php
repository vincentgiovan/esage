<nav class="fixed-top h-100" id="sidebar" style="background-color: rgb(69, 69, 69); z-index: 10;">
    <ul class="nav d-flex flex-column items-stretch flex-nowrap gap-2 py-3 overflow-y-auto" id="sidebar-menu">
        ...
        @if(in_array(Auth::user()->role->role_name, ['master', 'accounting_admin', 'purchasing_admin']))
            <li class="nav-item">
        ...
        @if(in_array(Auth::user()->role->role_name, ['master', 'accounting_admin', 'purchasing_admin', 'gudang', 'subgudang']))
            <li class="nav-item">
        ...
        @if(in_array(Auth::user()->role->role_name, ['master', 'accounting_admin', 'purchasing_admin', 'product_manager', 'gudang', 'subgudang']))
            <li class="nav-item">
        ...
        @if(in_array(Auth::user()->role->role_name, ['master', 'accounting_admin', 'project_manager']))
            <li class="nav-item">
        ...
        @if(in_array(Auth::user()->role->role_name, ['master', 'accounting_admin', 'project_manager', 'product_manager', 'gudang', 'subgudang']))  
            <li class="nav-item">
