<nav class="fixed-top h-100" id="sidebar" style="background-color: rgb(69, 69, 69); margin-top: 55px; z-index: 10;">
    <ul class="nav d-flex flex-column items-stretch gap-2 mt-3">
        ...
        <li class="nav-item">
            <a class="nav-link text-decoration-none fs-6 px-4" style="color: white; font-weight: bold; @if (Request::is("return*")) background-color: green; @else rgb(69, 69, 69); @endif" href="{{ route("returnitem-index") }}" ><i class="bi bi-bag-dash me-2"></i> Return Item</a>
        </li>
        ...
        @can("admin")
            ...
            <li class="nav-item">
                <a class="nav-link text-decoration-none fs-6 px-4" style="color: white; font-weight: bold; @if (Request::is("visit-log*")) background-color: green; @else rgb(69, 69, 69); @endif" href="{{ route("visitlog-index") }}" ><i class="bi bi-person-lines-fill me-2"></i> Visit Log</a>
            </li>
        @endcan
    </ul>
