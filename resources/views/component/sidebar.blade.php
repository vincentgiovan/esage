<nav class="fixed-top h-100" id="sidebar" style="background-color: rgb(69, 69, 69); z-index: 10;">
    <ul class="nav d-flex flex-column items-stretch flex-nowrap gap-2 py-3 overflow-y-auto" id="sidebar-menu">
        ...
        @if(in_array(Auth::user()->role->role_name, ['master', 'accounting admin', 'purchasing admin']))
            <li class="nav-item">
        ...
        @if(in_array(Auth::user()->role->role_name, ['master', 'accounting admin', 'gudang', 'subgudang']))
            <li class="nav-item">
        ...
        @if(in_array(Auth::user()->role->role_name, ['master', 'accounting admin', 'purchasing admin', 'gudang', 'subgudang']))
            <li class="nav-item">
        ...
        @if(in_array(Auth::user()->role->role_name, ['master', 'accounting admin', 'purchasing admin', 'product manager', 'gudang', 'subgudang']))
            <li class="nav-item">
        ...
        @if(in_array(Auth::user()->role->role_name, ['master', 'accounting admin', 'project manager', 'product manager', 'gudang', 'subgudang']))  
            <li class="nav-item">
