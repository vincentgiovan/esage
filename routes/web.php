...
Route::middleware(["auth", "verified"])->group(function(){
    ...
    // Only Masters Can Access These Pages
    ...
    Route::middleware(['master', 'accounting_admin'])->group(function(){
        // ===== ATTENDANCES ===== //
    ...
    // Masters, Accounting Admins, and Project Managers Can Access These Pages
    Route::middleware(['master', 'accounting_admin', 'project_manager'])->group(function(){
        // ===== SELF ATTENDANCES ===== //
