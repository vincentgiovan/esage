...
Route::middleware(["auth", "verified"])->group(function(){
    ...
    Route::middleware('allow:master,accounting_admin')->group(function(){
        ...
        Route::get('/prepays/generate/rollback', [PrepayController::class, 'rollback'])->name('prepay-rollback');
        ...
        Route::get('/prepays/estimate', [PrepayController::class, 'check_prepays'])->name('prepay-check');
    });
